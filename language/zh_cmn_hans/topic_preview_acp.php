...
$lang = array_merge($lang, array(
	...
	'TOPIC_PREVIEW_RICH_TEXT'		=> '显示富文本预览',
	'TOPIC_PREVIEW_RICH_TEXT_EXPLAIN'=> '预览将通过完整的 BBCode 渲染显示格式化内容。禁用后，预览将仅显示纯文本。',
	'TOPIC_PREVIEW_RICH_ATT'		=> '在富文本预览中显示附件',
	'TOPIC_PREVIEW_RICH_ATT_EXPLAIN'=> '在富文本预览中显示附件文件。如果要降低服务器负载，请禁用此选项。',
	'CHARS'							=> '字元',
