...
$lang = array_merge($lang, array(
	...
	'TOPIC_PREVIEW_RICH_TEXT'		=> 'Отображать предпросмотр с форматированным текстом',
	'TOPIC_PREVIEW_RICH_TEXT_EXPLAIN'=> 'В предпросмотре будет отображаться форматированное содержимое с полной обработкой BBCode. Если эта настройка отключена, отображается только обычный текст.',
	'TOPIC_PREVIEW_RICH_ATT'		=> 'Отображать вложения в предпросмотре с форматированным текстом',
	'TOPIC_PREVIEW_RICH_ATT_EXPLAIN'=> 'Показывать прикреплённые файлы в предпросмотре с форматированным текстом. Отключите эту настройку, если хотите снизить нагрузку на сервер.',
	'CHARS'							=> 'символов',
