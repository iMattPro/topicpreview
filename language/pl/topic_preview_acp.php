...
$lang = array_merge($lang, array(
	...
	'TOPIC_PREVIEW_EXPLAIN'			=> 'Podgląd tematu wyświetli fragment tekstu z pierwszego postu w dymku, gdy kursor myszy pojawi się nad tytułem tematu.',
	...
	'TOPIC_PREVIEW_RICH_TEXT'		=> 'Wyświetlaj podglądy z tekstem sformatowanym',
	'TOPIC_PREVIEW_RICH_TEXT_EXPLAIN'=> 'Podglądy będą wyświetlać sformatowaną treść z pełnym przetwarzaniem BBCode. Po wyłączeniu tej opcji podglądy będą zawierać tylko zwykły tekst.',
	'TOPIC_PREVIEW_RICH_ATT'		=> 'Wyświetlaj załączniki w podglądach z tekstem sformatowanym',
	'TOPIC_PREVIEW_RICH_ATT_EXPLAIN'=> 'Wyświetla załączone pliki w podglądach z tekstem sformatowanym. Wyłącz tę opcję, jeśli chcesz zmniejszyć obciążenie serwera.',
	'CHARS'							=> 'znaków',

	'TOPIC_PREVIEW_STYLE_SETTINGS'	=> 'Ustawienia stylu podglądu tematu',
	'TOPIC_PREVIEW_WIDTH'			=> 'Szerokość podglądu tematu (w pikselach)',
	...
	'TOPIC_PREVIEW_THEME_EXPLAIN'	=> 'Wybierz motyw podglądu tematu na %s.',
	'THEME'							=> 'motyw',
	'MILLISECOND'					=> 'ms',
));
