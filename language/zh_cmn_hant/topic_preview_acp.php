...
$lang = array_merge($lang, array(
	...
	'TOPIC_PREVIEW_RICH_TEXT'		=> '顯示富文字預覽',
	'TOPIC_PREVIEW_RICH_TEXT_EXPLAIN'=> '預覽將以完整的 BBCode 轉譯顯示格式化內容。停用後，預覽將僅顯示純文字。',
	'TOPIC_PREVIEW_RICH_ATT'		=> '在富文字預覽中顯示附件',
	'TOPIC_PREVIEW_RICH_ATT_EXPLAIN'=> '在富文字預覽中顯示附加檔案。如果要降低伺服器負載，請停用此選項。',
	'CHARS'							=> '字元',
