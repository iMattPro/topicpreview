...
$lang = array_merge($lang, array(
	...
	'TOPIC_PREVIEW_RICH_TEXT'		=> 'نمایش پیش‌نمایش‌های متن غنی',
	'TOPIC_PREVIEW_RICH_TEXT_EXPLAIN'=> 'پیش‌نمایش‌ها محتوای قالب‌بندی‌شده را با پردازش کامل BBCode نمایش می‌دهند. در صورت غیرفعال بودن، پیش‌نمایش‌ها فقط متن ساده را نشان می‌دهند.',
	'TOPIC_PREVIEW_RICH_ATT'		=> 'نمایش پیوست‌ها در پیش‌نمایش‌های متن غنی',
	'TOPIC_PREVIEW_RICH_ATT_EXPLAIN'=> 'فایل‌های پیوست‌شده را در پیش‌نمایش‌های متن غنی نمایش می‌دهد. اگر می‌خواهید بار سرور را کاهش دهید، این گزینه را غیرفعال کنید.',
	'CHARS'							=> 'کاراکتر',
