...
$lang = array_merge($lang, array(
	...
	'TOPIC_PREVIEW_RICH_TEXT'		=> 'عرض معاينات النص المنسق',
	'TOPIC_PREVIEW_RICH_TEXT_EXPLAIN'=> 'ستعرض المعاينات محتوى منسقًا مع معالجة BBCode كاملة. عند تعطيل هذا الخيار، تعرض المعاينات نصًا عاديًا فقط.',
	'TOPIC_PREVIEW_RICH_ATT'		=> 'عرض المرفقات في معاينات النص المنسق',
	'TOPIC_PREVIEW_RICH_ATT_EXPLAIN'=> 'عرض الملفات المرفقة في معاينات النص المنسق. عطّل هذا الخيار إذا كنت تريد تقليل حمل الخادم.',
	'CHARS'							=> 'حروف',
