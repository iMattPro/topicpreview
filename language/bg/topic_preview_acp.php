...
$lang = array_merge($lang, array(
	...
	'TOPIC_PREVIEW_RICH_TEXT'		=> 'Показване на визуализации с форматиран текст',
	'TOPIC_PREVIEW_RICH_TEXT_EXPLAIN'=> 'Визуализациите ще показват форматирано съдържание с пълно обработване на BBCode. Когато тази опция е изключена, визуализациите показват само обикновен текст.',
	'TOPIC_PREVIEW_RICH_ATT'		=> 'Показване на прикачени файлове във визуализациите с форматиран текст',
	'TOPIC_PREVIEW_RICH_ATT_EXPLAIN'=> 'Показване на прикачените файлове във визуализациите с форматиран текст. Изключете тази опция, ако искате да намалите натоварването на сървъра.',
	'CHARS'							=> 'символи',
